							...
							<div class="kopa-any-question">
								<p>
									...
									<a href="#">+38 237 948 236</a> 
									 / 
									<a href="#"><span class="__cf_email__" data-cfemail="a8e9ccc5c1c6e8dccdc9cbc0cdda86cbc7c5">[email&#160;protected]</span></a>
								</p>
							</div>
						</div>
					...
					<div class="container">
						<div class="widget kopa-widget-breadcrumb">
							<div class="widget-content">
								<h3 class="breadcrumb-title">All Courses</h3>
								<div class="breadcrumb-nav">
									...
									<span class="current-page">All Courses</span>
								</div>
							</div>
						</div>
					</div>
								...
								<div class="row">
									<div class="col-md-4 col-sm-6 col-xs-12">
										<article class="entry-item kopa-item-course-03">
											<div class="entry-thumb">
												<a href="#">
													<img src="images/list-course/6.jpg" alt="">
													<span>View Details</span>
												</a>
											</div>
											<div class="entry-content">
												<h4 class="entry-title">
													<a href="#">Introduction to Java & Python</a>
												</h4>
												<a href="#" class="course-author">
													<div class="thumb">
														<img src="images/testimonial/3.jpg" alt="">
													</div>
													<span>Johnathon Doe, IT Trainer</span>
												</a>
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<article class="entry-item kopa-item-course-03">
											<div class="entry-thumb">
												<a href="#">
													<img src="images/list-course/7.jpg" alt="">
													<span>View Details</span>
												</a>
											</div>
											<div class="entry-content">
												...
												<a href="#" class="course-author">
													...
													<span>Ashiful Pappu, IT Trainer</span>
												</a>
												<div class="course-price">
													<span class="price">$ 319</span>
													<div class="rating">
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<article class="entry-item kopa-item-course-03">
											<div class="entry-thumb">
												<a href="#">
													<img src="images/list-course/8.jpg" alt="">
													<span>View Details</span>
												</a>
											</div>
											<div class="entry-content">
												<h4 class="entry-title">
													<a href="#">HTML & CSS: Making a websites</a>
												</h4>
												<a href="#" class="course-author">
													<div class="thumb">
														<img src="images/testimonial/4.jpg" alt="">
													</div>
													<span>Sara Smithson, IT Trainer</span>
												</a>
												<div class="course-price">
													<span class="price">$ 319</span>
													<div class="rating">
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<article class="entry-item kopa-item-course-03">
											<div class="entry-thumb">
												<a href="#">
													<img src="images/list-course/9.jpg" alt="">
													<span>View Details</span>
												</a>
											</div>
											<div class="entry-content">
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<article class="entry-item kopa-item-course-03">
											<div class="entry-thumb">
												<a href="#">
													<img src="images/list-course/10.jpg" alt="">
													<span>View Details</span>
												</a>
											</div>
											<div class="entry-content">
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<article class="entry-item kopa-item-course-03">
											<div class="entry-thumb">
												<a href="#">
													<img src="images/list-course/11.jpg" alt="">
													<span>View Details</span>
												</a>
											</div>
											<div class="entry-content">
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<article class="entry-item kopa-item-course-03">
											<div class="entry-thumb">
												<a href="#">
													<img src="images/list-course/12.jpg" alt="">
													<span>View Details</span>
												</a>
											</div>
											<div class="entry-content">
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<article class="entry-item kopa-item-course-03">
											<div class="entry-thumb">
												<a href="#">
													<img src="images/list-course/13.jpg" alt="">
													<span>View Details</span>
												</a>
											</div>
											<div class="entry-content">
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<article class="entry-item kopa-item-course-03">
											<div class="entry-thumb">
												<a href="#">
													<img src="images/list-course/14.jpg" alt="">
													<span>View Details</span>
												</a>
											</div>
											<div class="entry-content">
