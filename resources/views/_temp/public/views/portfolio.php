							...
							<div class="kopa-any-question">
								<p>
									...
									<a href="#">+38 237 948 236</a> 
									 / 
									<a href="#"><span class="__cf_email__" data-cfemail="2766434a4e4967534246444f42550944484a">[email&#160;protected]</span></a>
								</p>
							</div>
						</div>
					...
					<div class="container">
						<div class="widget kopa-widget-portfolio">
							<header class="widget-header style-01">
								...
								<h3 class="widget-title">PORTFOLIO 2 COLUMN</h3>
								<h4>See our features courses or see all</h4>
							</header>
							<div class="widget-content">
								<header class="masonry-header">
	                                <div class="masonry-filter">
	                                    <a href="#" data-val="*" class="active">All portfolio</a>
	                                    <a href="#" data-val="1" >PHOTOGRAPHY</a>
	                                    <a href="#" data-val="2" >TECHNOLOGY</a>
	                                </div>
	                                <!-- masonry-filter -->
	                            </header>
	                            <div class="masonry-content row">
	                            	<div class="ms-item show parent-container col-md-6 col-sm-6 col-xs-12" data-val="1">
	                            	...
	                            	<div class="ms-item show parent-container col-md-6 col-sm-6 col-xs-12" data-val="1,2">
	                            		<article class="entry-item kopa-ms-item-01">
	                            			<div class="entry-thumb">
