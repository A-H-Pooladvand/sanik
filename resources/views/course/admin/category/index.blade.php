...
@section('content')
    ...
    @push('scripts')
        <script>
            ...
            $('#tt').iTreeGrid({
                    title: 'لیست دسته بندی های دروس',
                    url: '{{ route('admin.course.category.items') }}',
                    idField: 'id',
                    treeField: 'title',
                    columns: [[
                    ...
                    toolbar: [
                        {
                            name: 'show',
                            link: '{{ route('admin.course.category.index') }}' + '/' + '{id}',
                        },
                        {
                            name: 'edit',
                            link: '{{ route('admin.course.category.index') }}' + '/' + 'edit' + '/' + '{id}',
                        },
                        {
                            name: 'delete',
                            link: '{{ route('admin.course.category.index') }}' + '/' + '{id}',
