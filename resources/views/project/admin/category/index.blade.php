...
@section('content')
    ...
    @push('scripts')
        <script>
            ...
            $('#tt').iTreeGrid({
                    title: 'لیست دسته بندی های پروژه ها',
                    url: '{{ route('admin.project.category.items') }}',
                    idField: 'id',
                    treeField: 'title',
                    columns: [[
                    ...
                    toolbar: [
                        {
                            name: 'show',
                            link: '{{ route('admin.project.category.index') }}' + '/' + '{id}',
                        },
                        {
                            name: 'edit',
                            link: '{{ route('admin.project.category.index') }}' + '/' + 'edit' + '/' + '{id}',
                        },
                        {
                            name: 'delete',
                            link: '{{ route('admin.project.category.index') }}' + '/' + '{id}',
