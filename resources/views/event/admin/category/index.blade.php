...
@section('content')
    ...
    @push('scripts')
        <script>
            ...
            $('#tt').iTreeGrid({
                    title: 'لیست دسته بندی های برنامه های آتی',
                    url: '{{ route('admin.event.category.items') }}',
                    idField: 'id',
                    treeField: 'title',
                    columns: [[
                    ...
                    toolbar: [
                        {
                            name: 'show',
                            link: '{{ route('admin.event.category.index') }}' + '/' + '{id}',
                        },
                        {
                            name: 'edit',
                            link: '{{ route('admin.event.category.index') }}' + '/' + 'edit' + '/' + '{id}',
                        },
                        {
                            name: 'delete',
                            link: '{{ route('admin.event.category.index') }}' + '/' + '{id}',
