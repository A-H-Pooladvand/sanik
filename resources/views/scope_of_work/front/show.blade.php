                ...
                <div class="container">
                    ...
                    <div class="post">
                        ...
                        <div class="post-thumbnail text-center">
                            ...
                            <div class="img--custom" style="background: url({{ image_url($scope->image, 108, 60) }}) no-repeat center center; width: 100%; height: 300px;background-size: cover;border-radius: 4px"></div>
