...
@section('content')
    ...
    @push('scripts')
        <script>
            ...
            $('#tt').iTreeGrid({
                    title: 'لیست دسته بندی های کوتاه و شنیدنی ها',
                    url: '{{ route('admin.audible.category.items') }}',
                    idField: 'id',
                    treeField: 'title',
                    columns: [[
                    ...
                    toolbar: [
                        {
                            name: 'show',
                            link: '{{ route('admin.audible.category.index') }}' + '/' + '{id}',
                        },
                        {
                            name: 'edit',
                            link: '{{ route('admin.audible.category.index') }}' + '/' + 'edit' + '/' + '{id}',
                        },
                        {
                            name: 'delete',
                            link: '{{ route('admin.audible.category.index') }}' + '/' + '{id}',
