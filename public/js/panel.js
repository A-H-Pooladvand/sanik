...
$(function () {
    ...
    $('.sidebar__item > li ul a').click(function () {
        ...
        console.log(sessionStorage.getItem('active_menu'));
    });
...
$(function () {
    ...
    function appendNewImage() {
        $('#lfm--wrapper').append($('<div />', { class: 'col-lg-3 col-sm-3 display-none lfm--images__wrapper' }).append($('<div />', { class: 'form-group form-group-sm' }).append($('<div />', { class: 'position-relative thumbnail' }).append($('<div />', { class: 'btn-remove' }), $('<img />', { id: 'gallery-preview' + $lfm_counter, class: 'lfm--images full-width m-b-1', height: 150 }), $('<input />', { class: 'form-control m-b-1', type: 'text', name: 'lfm_gallery_title[]', placeholder: 'عنوان' }), $('<input />', { class: 'form-control', type: 'number', name: 'lfm_gallery_priority[]', placeholder: 'اولویت 1-255' }), $('<input />', { type: 'hidden', id: 'gallery-path' + $lfm_counter, name: 'lfm_gallery_path[]' })))));
    }
