...
namespace App\Http\Controllers\Project\Admin\Category;
...
class CategoryController extends Controller
{
    ...
    {
        return view('project.admin.category.index');
    }
    ...
    {
        $form = ['action' => route('admin.project.category.store')];
        ...
        return view('project.admin.category.form', compact('form', 'categories'));
    }
    ...
    {
        $category = Category::with('parent')->where('category_type', Project::class)->findOrFail($id);

        return view('project.admin.category.show', compact('category', 'categories'));
    }
    ...
    public function edit($id)
    {
        ...
        $form = [
            'action' => route('admin.project.category.update', $category['id']),
            'method' => 'put'
        ];
        ...
        return view('project.admin.category.form', compact('category', 'form', 'categories'));
    }

    public function update(Request $request, $id)
    {
        $category = Category::where('category_type', Project::class)->findOrFail($id);
    ...
    public function destroy($id)
    {
        ...
        $categories = Category::with('children')->where('category_type', Project::class);
    ...
    private function validator(Request $request, Category $category = null)
    {
        ...
        if ($request->method() === 'PUT')
            $rules['slug'] = 'required|regex:/(^[A-Za-z-_ ]+$)+/|unique:categories,slug,' . $category->id . ',id,category_type,' . Project::class;
